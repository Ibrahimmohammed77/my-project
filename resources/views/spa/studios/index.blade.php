...
@section('content')
    ...
    <x-modal id="studio-details-modal" title="تفاصيل الاستوديو" maxWidth="4xl">
        <div id="studio-details-content" class="p-6 space-y-8 text-right">
            <!-- Loading State -->
            <div id="studio-details-loading" class="flex flex-col items-center justify-center py-12">
            ...
            <div id="studio-details-data" class="hidden space-y-8">
                <!-- Profile Header -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div class="p-6 bg-blue-50/50 rounded-2xl border border-blue-100/50 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-xs text-blue-600 font-bold mb-0.5">الألبومات</p>
                    ...
                    <div class="p-6 bg-purple-50/50 rounded-2xl border border-purple-100/50 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-xs text-purple-600 font-bold mb-0.5">الكروت</p>
                    ...
                    <div class="p-6 bg-orange-50/50 rounded-2xl border border-orange-100/50 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-xs text-orange-600 font-bold mb-0.5">العملاء</p>
                            <h4 id="stat-customers" class="text-2xl font-bold text-gray-900">0</h4>
                        </div>
                    </div>
                    <div class="p-6 bg-green-50/50 rounded-2xl border border-green-100/50 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-xs text-green-600 font-bold mb-0.5">العمولات</p>
                            <h4 id="stat-commissions" class="text-2xl font-bold text-gray-900">0</h4>
                        </div>
                    </div>
                </div>
        ...
        <x-slot name="footer">
            ...
            <x-button id="edit-from-details" variant="primary" class="bg-purple-600 hover:bg-purple-700">تعديل البيانات</x-button>
        </x-slot>
    </x-modal>
