...
@section('content')
    <x-page-header title="إدارة الصلاحيات">
        <div class="relative min-w-[240px]">
            ...
            <input type="text" id="permissions-search" placeholder="بحث عن صلاحية..." class="w-full pl-4 pr-10 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all text-sm">
        </div>
...
@push('scripts')
    @vite('resources/js/spa/modules/permissions/index.js')
@endpush
@endsection
